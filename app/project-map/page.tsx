...
const pages: PageDocumentation[] = [
  ...
  },
  {
    ...
    status: 'planned',
    lastModified: '2025-08-20',
    technologies: ['Next.js 14', 'TypeScript', 'SQLite'],
    components: ['ProjectsList', 'ProjectCard', 'CreateProject'],
    parent: 'root',
    level: 1,
    type: 'section',
  ...
  },
  {
    ...
    name: 'רשימת פרויקטים',
    path: '/projects',
    description: 'תצוגת כל הפרויקטים הפעילים והארכיון',
    status: 'planned',
    lastModified: '2025-08-20',
    technologies: ['React', 'SQLite', 'Search API'],
    components: ['ProjectsList', 'SearchBar', 'FilterTabs'],
  ...
  },
  {
    ...
    name: 'המדריך ל-AI',
    path: '/guide-for-ai',
    description: 'מדריך מקיף לסוכני AI הכולל כל המידע הטכני והמבני על הפרויקט',
    status: 'completed',
    lastModified: '2025-08-20',
